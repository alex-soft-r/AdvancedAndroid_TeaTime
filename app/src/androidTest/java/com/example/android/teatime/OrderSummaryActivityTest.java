...
public class OrderSummaryActivityTest {
    ...
    @Rule public
    IntentsTestRule mIntentsTestRule
            = new IntentsTestRule(OrderSummaryActivity.class);


    // FIXED (3) Finish this method which runs before each test and will stub all external
    ...
    // FIXED (4) Finish this method which verifies that the intent sent by clicking the send email
