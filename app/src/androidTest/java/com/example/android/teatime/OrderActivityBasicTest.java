...
public class OrderActivityBasicTest {
    ...
    @Rule public
    ActivityTestRule<OrderActivity> mOrderActivityActivityTestRule =
            new ActivityTestRule<>(OrderActivity.class);

    // DONE (3) Finish writing this test which will:
    //         DONE - Check that the initial quantity is zero
    //         DONE - Click on the decrement button
    //         DONE - Verify that the decrement button won't decrease the quantity 0 and cost below $0.00
    @Test
